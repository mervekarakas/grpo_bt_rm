...
echo "[setup_env] BT_SCORE_PARSER=${BT_SCORE_PARSER:-<unset>}  BT_DELTA_TEMP=${BT_DELTA_TEMP:-<unset>}  BT_DELTA_CLIP=${BT_DELTA_CLIP:-<unset>}  BT_DELTA_NEG_CLIP=${BT_DELTA_NEG_CLIP:-<unset>}  BT_REWARD_SCALE=${BT_REWARD_SCALE:-<unset>}  BT_REWARD_OFFSET=${BT_REWARD_OFFSET:-<unset>}  BT_HARD_TAU=${BT_HARD_TAU:-<unset>}  BT_HARD_LAMBDA=${BT_HARD_LAMBDA:-<unset>}"
